...
export default function SecuritySuccessModal({ onClose }: SuccessModalProps) {
  return (
    <div className="flex w-full max-w-md flex-col items-center rounded-xl bg-white p-8">
      ...
      <div className="mb-6 text-center">
        <div className="mb-2 text-lg font-semibold">Security settings updated successfully!</div>
      </div>
      <button
        onClick={onClose}
