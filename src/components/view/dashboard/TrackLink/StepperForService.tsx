              ...
              className={`relative z-10 flex size-10 items-center justify-center rounded-full border-[3px] transition-all duration-300 ease-in-out
                ${
                  step.status === 'completed'
                    ...
                    : step.status === 'current'
                      ? 'border-green-500 bg-white text-green-600 shadow-lg shadow-green-200 step-pulse ripple-effect'
                      : step.status === 'disputed'
                        ? 'border-red-500 bg-gradient-to-br from-red-400 to-red-600 text-white shadow-lg shadow-red-200 hover:shadow-xl hover:shadow-red-300 hover:scale-110 ripple-effect'
                        : step.status === 'refunded'
