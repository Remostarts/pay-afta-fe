              ...
              <li key={nav.id}>
                {isChildren ? (
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value={`item-${nav.id}`}>
                      <AccordionTrigger
                      ...
                      <AccordionContent className="pl-10 space-y-2 mt-2">
                        {[nav.newOrder, nav.viewOrder].map((subNav) => {
                          ...
                          return (
                            <Link
                              ...
                              className={`flex items-center gap-4 rounded-md p-2 hover:bg-[#E9F5FB] hover:text-[#1F7EAD] transition-colors ${
                                subIsActive ? 'bg-[#E9F5FB] text-[#1F7EAD]' : ''
                              }`}
                              onClick={() => {
